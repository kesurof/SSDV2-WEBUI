...
| 0 — Contrat SSDV2 | `ssdv2ctl` non interactif JSON (apps, app, auth, diagnostics) | En cours — lecture seule livrée localement (`apps list`, `app status` ; développement local uniquement, ADR-0010) |
