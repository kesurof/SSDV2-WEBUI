...
| 4 — Administration | Auth en masse, configuration, notifications persistantes, audit, backups, diagnostics | En cours — diagnostics, notifications, audit, sauvegardes, auth en masse et config (lecture) livrés ; reste : restauration (SSDV2) et config en écriture |
