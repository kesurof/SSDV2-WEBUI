...
| 4 — Administration | Auth en masse, configuration, notifications persistantes, audit, backups, diagnostics | En cours — diagnostics réparateurs livrés (jobs) ; reste : notifications persistantes, audit, backups, `ssdv2ctl config` |
