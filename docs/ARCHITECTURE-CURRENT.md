...
- `frontend/` : React 19 + Vite 8 + TypeScript 5.9 + Tailwind 4 + shadcn/ui +
  ...
  applications (recherche, filtres, badges d'état, alertes, bandeau mode dégradé), page de
  détail d'application (vue générale, conteneurs, volumes, réseau/DNS), page Diagnostics.
