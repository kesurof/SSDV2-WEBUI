...
- Serveur de test : `ssh kesurof@141.145.198.119 "cd ~/ssdv2-webui && git pull && docker compose up -d --build"` ;
  UI sur `127.0.0.1:8800` uniquement (tunnel : `ssh -L 8800:127.0.0.1:8800 kesurof@141.145.198.119`).
